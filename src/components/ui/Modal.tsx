...
const Modal = ({
	...
	centered,
	scrollContent,
	themeClass = "border dark:bg-slate-800 dark:border-b dark:border-slate-700",
	title = "Basic Modal",
	uncontrol,
	label = "Basic Modal",
	labelClass,
				...
				<>
                 ...
                 bg-white dark:bg-slate-800 text-left align-middle shadow-xl transition-alll ${className}`}
										>
											...
											>
												<h2 className="leading-6 tracking-wider font-bold text-base text-dark">
													{title}
												</h2>
									...
									>
										...
										>
											...
											<button onClick={onClose} className="text-[22px]">
												<Icon icon="heroicons-outline:x" className="css-ma-d-a1" />
											</button>
										</div>
										<div
											className={`px-6 py-8 ${bodyClass} ${scrollContent ? "overflow-y-auto max-h-[400px]" : ""
												}`}
										>
											{children}
										</div>
