      ...
      >
        {({ isActive }: { isActive: boolean }) => (
          <div className="h-[50px] w-[50px] rounded-full relative left-[0px] top-[0px] custom-dropshadow">
            <img
              src={'https://img.freepik.com/premium-vector/business-man-with-notebook-office-high-resolution-real-hand-vector-illustration-cartoon_969863-494.jpg?size=626&ext=jpg&uid=R10748925&ga=GA1.2.289817298.1683725416&semt=ais'}
              alt=""
